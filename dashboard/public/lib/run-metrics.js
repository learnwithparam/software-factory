// Ported from owainlewis/machinist@3943516 internal/controlplane/web/src/run-metrics.js:1-end (MIT, Copyright (c) 2026 Owain Lewis). Deviations: none; verbatim. Callers adapt stage_runs rows to the job/run shape (dashboard/analytics.ts).
