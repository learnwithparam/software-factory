// Ported from owainlewis/machinist@3943516 internal/controlplane/web/src/runs-board.js:1-end (MIT, Copyright (c) 2026 Owain Lewis). Deviations: none; verbatim. Callers map factory run states onto these states (dashboard/analytics.ts).
