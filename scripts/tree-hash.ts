...
export const STAMPED: ReadonlyArray<readonly [string, string]> = [
	...
	['design/', 'the token source every generated stylesheet is rendered from'],
...
export const NOT_STAMPED: ReadonlyArray<readonly [string, string]> = [
	['teach.html', 'prose: the concept spine'],
	['teach/', 'prose: the run sheets, the generated stylesheet and the printed sheets'],
...
export const NOT_STAMPED_SCRIPTS: ReadonlyArray<readonly [string, string]> = [
	...
	['scripts/book.ts', 'composes the printed book'],
