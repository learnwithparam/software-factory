...
<main class="doc">
<header class="cover">
<p class="series">Software Factory · evidence</p>
<h1>What the run produced</h1>
<p class="deck">Every picture the end-to-end run took, in the order the specs take them. Each one carries what it
