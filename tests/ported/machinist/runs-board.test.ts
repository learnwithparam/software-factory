// Ported from owainlewis/machinist@3943516 internal/controlplane/web/src/runs-board.test.js (MIT, Copyright (c) 2026 Owain Lewis). Deviations: bun:test instead of node:test.
// @ts-nocheck
import assert from "node:assert/strict";
import { test } from "bun:test";
import { boardColumnForState, filterJobs, githubIssueReference, groupJobsByBoardColumn, jobDisplayTitle, needsAttention } from "../../../dashboard/public/lib/runs-board.js";
