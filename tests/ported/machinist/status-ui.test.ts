// Ported from owainlewis/machinist@3943516 internal/controlplane/web/src/status-ui.test.js (MIT, Copyright (c) 2026 Owain Lewis). Deviations: bun:test instead of node:test.
// @ts-nocheck
import assert from "node:assert/strict";
import { test } from "bun:test";
import { analyticsState } from "../../../dashboard/public/lib/analytics-state.js";
import { createStatusLoader } from "../../../dashboard/public/lib/status-loader.js";
