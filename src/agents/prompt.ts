...
export function artifactContract(opts: Pick<StageRunOptions, "stage" | "issue">): string {
  return [
    "## Artifact contract",
    "",
...
export async function renderPrompt(opts: StageRunOptions): Promise<string> {
